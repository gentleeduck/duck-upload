...
```bash
git clone https://github.com/gentleeduck/duck-upload.git
cd duck-upload
```
...
If you find a bug, please [open an issue](https://github.com/gentleeduck/duck-upload/issues) with:
...
* **Community**: Helping others in discussions, writing blog posts, or sharing duck-upload
...
* Look at the ["good first issue"](https://github.com/gentleeduck/duck-upload/labels/good%20first%20issue) label for beginner-friendly contributions.
